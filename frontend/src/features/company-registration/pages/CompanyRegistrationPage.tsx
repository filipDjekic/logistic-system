              ...
              <Grid container spacing={2.5}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Controller name="companyEmail" control={form.control} render={({ field, fieldState }) => (
                    <TextField {...field} label="Company email (auto-generated)" fullWidth disabled error={!!fieldState.error} helperText={fieldState.error?.message || 'Generated automatically from the company name and country.'} InputProps={{ endAdornment: <InputAdornment position="end"><Tooltip title="Generated automatically and submitted with the request"><InfoOutlinedIcon fontSize="small" /></Tooltip></InputAdornment> }} />
                  )} />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
          ...
          {activeStep === 2 ? (
            <Stack spacing={3}>
              ...
              <Grid container spacing={2.5}>
                ...
                <Grid size={{ xs: 12, md: 6 }}><Controller name="adminEmail" control={form.control} render={({ field, fieldState }) => <TextField {...field} label="Admin email (auto-generated)" fullWidth disabled error={!!fieldState.error} helperText={fieldState.error?.message || 'Generated automatically from the administrator and company details.'} />} /></Grid>
