        ...
        filters={
          <>
            ...
            <FilterPanel>
              ...
              {canResolveEmployees ? (
                <EntityLookupField label="Driver" lookupParams={{ position: 'DRIVER', activeOnly: true }} entityType="employees" value={driverFilter} onChange={(option) => { setPage(0); setDriverFilter(option); }} placeholder="All" searchPlaceholder="Search drivers..." />
              ) : null}
            </FilterPanel>
          </>
        }
