...
public class Employee {
    ...
    @Column(name = "auto_generated_email", nullable = false)
    private Boolean autoGeneratedEmail = false;

    @Column(name = "email_manually_overridden", nullable = false)
    private Boolean emailManuallyOverridden = false;

    @Column(name = "email_generation_source", length = 80)
    ...
    private void normalize() {
        ...
        if (autoGeneratedEmail == null) {
            autoGeneratedEmail = false;
        }
        if (emailManuallyOverridden == null) {
            emailManuallyOverridden = false;
        }
        if (emailGenerationSource != null) {
            emailGenerationSource = emailGenerationSource.trim();
        }
    }
}
